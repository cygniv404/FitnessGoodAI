...
export default function Header() {
  ...
  return !isLoggedIn ? (
    <div className="px-8 py-8 fixed z-10 w-full" style={outerDivStyle}>
      ...
      >
        <div>
          <p className="text-2xl cursor-pointer">FitnessGoodAI</p>
        </div>
            ...
            >
              ...
              <li>
                <button
                  ...
                  className="bg-[#1be95c] text-black px-5 py-1.5 rounded-full hover:bg-[#0a7e29]"
                >
                  Sign in
                </button>
              </li>
              <li>
                <button
                  ...
                  className="bg-[#1be95c] text-black px-5 py-1.5 rounded-full hover:bg-[#0ca234]"
                >
                  Sign up
                </button>
              </li>
        ...
        {!isMobile && (
          <div className="flex items-center gap-5">
            <button
              onClick={handleLoginClick}
              className="bg-[#1be95c] text-black px-5 py-0.5 rounded-full hover:bg-[#6cd81e]"
            >
              Login
            </button>
            <button
